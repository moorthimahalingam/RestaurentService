...
public class RestaurantEmpRegCROSFilter implements Filter {

	Logger logger = LoggerFactory.getLogger(RestaurantEmpRegCROSFilter.class);
	
	public RestaurantEmpRegCROSFilter() {
		logger.debug("RestaurantEmpRegCROSFilter constructor");
	}
